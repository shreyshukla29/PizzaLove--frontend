...
function Home() {
  ...
  return (
    <div>
      ...
      <section className="mt-6 py-4 px-4 flex flex-col lg:flex-row  lg:justify-center">
        ...
        <div className=" p-6 ">
          ...
          <p className="text-justify">
            At Pizza App, we are passionate about crafting exceptional pix=zzas that brings joy to every bite. Our journey began with a commitment to using the freshest, high-quality ingredients, combined with authentic recipes passed down through generations. Whether you're craving a classic Margherita or an adventurous speciality pizza, each creation is  made with care and attention to detail. Join us in celebrating the art of pizza-making and indulge in flavourse that will leave you wanting more. Welcome to the world of Pizza App, where every pizza tells a deliicous story.
          </p>
        </div>
      </div>
